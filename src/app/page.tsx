...
export default function HomePage() {
  return (
    <>
      <section className="relative flex min-h-[60vh] items-center bg-gradient-to-br from-primary/10 via-background to-secondary/30">
      ...
      <SectionWrapper>
        <div className="text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            12+ специализирани процедури за вашето здраве и добро самочувствие.
          </p>
          <div className="mt-8">
